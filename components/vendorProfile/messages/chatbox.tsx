...
const Chatbox = ({ user }: { user: boolean }) => {
  return (
      ...
      <div className="w-full h-[60px] border-b border-b-paginationBg-900 px-4 flex justify-between items-center">
        ...
        <div className="w-full flex justify-end">
          <div className="text-textSecondary-900 flex gap-4">
            <i
              className="fa-regular fa-star cursor-pointer hover:text-textPrimary-900 duration-200"
              title="Mark the Conversation as Star"></i>
            <i
              className="fa-solid fa-trash cursor-pointer hover:text-textPrimary-900 duration-200"
              title="Delete"></i>
            <i
              className="fa-regular fa-envelope-open cursor-pointer hover:text-textPrimary-900 duration-200"
