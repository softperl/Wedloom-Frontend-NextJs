    ...
    <Link href={slugify(`/vendors/all/${text}`)} className="w-full h-full">
      <div className="w-full">
        <div className="psearchCarousel__content w-full d-flex justify-between items-center">
          <div className="pSearch__img overflow-hidden relative aspect-video rounded-md bg-gray-100 shadow-sm">
            <Image
              fill
              src={img || ""}
              alt={text}
              className="lg:w-full object-contain hover:scale-125 duration-200 rounded-lg"
            />
          </div>
