...
const Review = ({ review, heading }: any) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      await createReview({
        vendorId: "cm0cqkyk10003yphwe3pew7sl",
        rating: starRate?.toString(),
            ...
            <div className="rating_form_content">
              ...
              <form onSubmit={handleSubmit} className="form__start">
                ...
                <div className="button_area mt-4 text-center lg:text-end">
                  <label htmlFor="file">
                    <div className="inline-flex border border-paginationBg-900 px-4 py-2 text-textSecondary-900">
                      Add Photos
                    </div>
                    <input
                      type="file"
                  ...
                  <button
                    type={"submit"}
                    disabled={isLoading}
                    className="bg-textPrimary-900 px-4 py-2 text-white ml-4 inline-flex items-center">
